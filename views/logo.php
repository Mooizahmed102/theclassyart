        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="nft-images">
                    <div class="nft-item">
                        <img src="assets/images/group65.png" alt="">
                        
                    </div>
                    <div class="nft-item">
                        <img src="assets/images/grou80.png" alt="">
                        
                    </div>
                    <div class="nft-item">
                        <img src="assets/images/group81.png" alt="">
                        
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <img src="assets/images/sidebanner.png" alt="" class="main-image">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <div class="image-container">
                    <img src="assets/images/boxex.png" alt="" class="centered-image">
                </div>
            </div>
        </div>
    </div>
...
<h1>How it's all done</h1>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="assets/images/group85.png" alt="">
            </div>
            <div class="col-md-6">
                <div class="min-nft">
                    <h1>Insights</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img src="assets/images/group86.png" alt="">
            </div>
        </div>
    </div>
</div>
<div class="services-third">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
            <img src="assets/images/group87.png" alt="">
            </div>
            <div class="col-md-6">
            <div class="min-nft">
                    <h1>Insights</h1>
